...
// FIX: Updated all icon components to accept standard React SVG props (e.g., style, onClick)
// for better flexibility and to resolve type errors when passing non-className props.
...
export const EldoriaLogo: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg
    {...props}
    viewBox="0 0 60 75"
    fill="currentColor"
...
export const BotIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <EldoriaLogo {...props} />;
...
export const EmeraldMindIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M6 2L1 7v10l5 5h12l5-5V7l-5-5H6zm10.14 14.83L12 19l-4.14-2.17L5 12l2.86-4.83L12 5l4.14 2.17L19 12l-2.86 4.83z" />
    </svg>
);

export const SAFIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
export const ContinueIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const ThoughtIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const LoadingSpinnerIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
...
export const SystemIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M12 5.25v13.5M12 3.75h.008v.008H12V3.75zm0 3.75h.008v.008H12V7.5zm0 3.75h.008v.008H12v-.008zm0 3.75h.008v.008H12v-.008zm0 3.75h.008v.008H12v-.008zM16.5 5.25h1.5v13.5h-1.5V5.25z" />
    </svg>
);
